...
export default function Footer({ fixed = false }) {
  ...
  return (
    <footer
      role="contentinfo"
      className={`print-hidden ${fixed ? 'fixed bottom-0 left-0 right-0' : ''} z-40 h-12 border-t border-gray-200 dark:border-gray-800 bg-background/75 backdrop-blur supports-[backdrop-filter]:bg-background/60`}
    >
